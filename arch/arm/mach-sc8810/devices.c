...
static struct led_gpio_flash_platform_data t2m_flash_platform_data = {
	.leds_type = FLASH_BRIGHTLESS_FIXED,
	.flash_gpio = 135,
};

struct platform_device t2m_leds_device = {
	.name = LED_GPIO_FLASH_DEVICE_NAME,
	.id = -1,
	.dev = { .platform_data = &t2m_flash_platform_data },
};
